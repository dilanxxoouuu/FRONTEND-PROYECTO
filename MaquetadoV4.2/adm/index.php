		...
		<div class="container-fluid">
		  ...
		  <div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
			  ...
			  <li class="nav-item">
				<a class="nav-link" href="index.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-wide" viewBox="0 0 16 16">
                ...
                <div class="card menu-container">
                    <div class="card-body text-center">
                        ...
                        <ul class="list-unstyled">
                            <li class="menu-item"><a href="Controlador/controladorUsuario.php" class="btn btn-dark btn-lg btn-block menu-button">Usuarios</a></li><hr>
                            <li class="menu-item"><a href="Controlador/controladorProducto.php" class="btn btn-dark btn-lg btn-block menu-button">Productos</a></li><hr>
                            <li class="menu-item"><a href="Controlador/controladorCategoria.php" class="btn btn-dark btn-lg btn-block menu-button">Categoria</a></li><hr>                 
                        </ul>                 
                        </ul>
                    </div>
                </div>                

<?php
session_start();
require_once 'Logs/Modelo/usuario.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $resultado = $gestorUsuario->verificarUsuario($usuario, $clave);

    if ($resultado) {
        list($usuario_id, $usuario_nombre, $usuario_apellido) = $resultado;
        $_SESSION['usuario_id'] = $usuario_id;
        $_SESSION['usuario_nombre'] = $usuario_nombre;
        $_SESSION['usuario_apellido'] = $usuario_apellido;

...
const VistaPerfilUsuario = () => {
  ...
  // Función para navegar a EnvioMapa
  const handleGoToEnvioMapa = () => {
    navigate('/envio'); // Esto llevará al usuario al componente EnvioMapa
  };
  ...
  return (
    ...
    >
      ...
      {/* Botón para navegar a EnvioMapa */}
      <motion.button
        className="go-to-envio-btn"
        onClick={handleGoToEnvioMapa}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.4 }}
        style={{
